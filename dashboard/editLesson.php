        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">تعديل درس</h1>
                </div>

                <div class="row g-3">
                    <div class="col-md-7 col-lg-8">
                        <h4 class="mb-3"></h4>
                        <form method="post" action="../control/edit_lesson.php" class="needs-validation">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label for="title" class="form-label">عنوان الدرس</label>
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" name="title" id="title" placeholder="" value="<?= $dbTitle ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group has-validation">
                                        <textarea class="form-control" name="memo" id="memo" rows="2" placeholder=""><?= $dbMemo ?></textarea>
