        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">حذف مستخدم</h1>
                </div>

                <div class="row g-3">
                    <div class="col-md-7 col-lg-8">
                        <h4 class="mb-3"></h4>
                        <form method="post" action="../control/delete_user.php" class="needs-validation">
                            <div class="row g-3">
                                <div class="col-12">
                                    <label for="name" class="form-label">الأسم</label>
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="" value="<?= $dbName ?>" disabled>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" placeholder="" value="<?= $dbEmail ?>" disabled>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" name="role" id="role" <?= $dbId === $_SESSION['id'] ? 'disabled' : '' ?> disabled>
                            ...
                            <hr class="my-4">
                            <a href="users.php" class="btn btn-secondary" type="submit">الغاء</a>
